...
See https://github.com/InsightEdge/insightedge-geo-demo.git for the complete example.
...
![Alt architecture](https://github.com/InsightEdge/insightedge-geo-demo/blob/master/docs/img/geo-demo-arch-diagram.jpg?raw=true "architecture")
...
![Alt demo screenshot](https://github.com/InsightEdge/insightedge-geo-demo/blob/master/docs/img/demo_screenshot.jpg?raw=true "demo screenshot")
